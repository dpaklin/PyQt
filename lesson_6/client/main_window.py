...
from lesson_6.client.main_window_conv import Ui_MainClientWindow
from lesson_6.client.add_contact import AddContactDialog
from lesson_6.client.del_contact import DelContactDialog
