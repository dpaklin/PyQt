...
from lesson_7.client.main_window_conv import Ui_MainClientWindow
from lesson_7.client.add_contact import AddContactDialog
from lesson_7.client.del_contact import DelContactDialog
