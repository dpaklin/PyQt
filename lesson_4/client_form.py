...
"}")
        ...
        self.scrollArea = QtWidgets.QScrollArea(self.tab_chat)
        self.scrollArea.setGeometry(QtCore.QRect(10, 10, 150, 464))
        self.scrollArea.setStyleSheet("background-color: violet;")
        self.scrollArea.setWidgetResizable(True)
        self.scrollArea.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignTop)
        self.scrollArea.setObjectName("scrollArea")
        self.scrollAreaWidgetContents = QtWidgets.QWidget()
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 148, 462))
...
"color: black;")
        ...
        self.list_chat = QtWidgets.QListWidget(self.tab_chat)
